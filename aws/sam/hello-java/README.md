...
This is a sample template for hello-java - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name hello-java --query 'Stacks[].Outputs'
```
